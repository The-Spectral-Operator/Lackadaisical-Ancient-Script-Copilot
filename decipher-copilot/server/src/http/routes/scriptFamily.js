...
const SCRIPT_REGISTRY = [
  ...
  { id: 'devanagari', display: 'Devanagari', family_id: 'indic', region: 'India', writing_type: 'abugida', status: 'deciphered' },
  { id: 'bengali', display: 'Bengali', family_id: 'indic', region: 'Bengal', writing_type: 'abugida', status: 'deciphered' },
  { id: 'gujarati', display: 'Gujarati', family_id: 'indic', region: 'Gujarat', writing_type: 'abugida', status: 'deciphered' },
  { id: 'gurmukhi', display: 'Gurmukhi', family_id: 'indic', region: 'Punjab', writing_type: 'abugida', status: 'deciphered' },
  { id: 'oriya', display: 'Oriya (Odia)', family_id: 'indic', region: 'Odisha', writing_type: 'abugida', status: 'deciphered' },
  { id: 'sinhala', display: 'Sinhala', family_id: 'indic', region: 'Sri Lanka', writing_type: 'abugida', status: 'deciphered' },
  { id: 'kharosthi', display: 'Kharosthi', family_id: 'indic', region: 'Gandhara', writing_type: 'abugida', status: 'deciphered' },
  ...
  { id: 'oracle_bone', display: 'Oracle Bone Script', family_id: 'east_asian', region: 'China', writing_type: 'logographic', status: 'partially_deciphered' },
  { id: 'tangut', display: 'Tangut (Xixia)', family_id: 'east_asian', region: 'Northwest China', writing_type: 'logographic', status: 'deciphered' },
  { id: 'khitan_large', display: 'Khitan Large Script', family_id: 'east_asian', region: 'Mongolia/Manchuria', writing_type: 'logographic', status: 'partially_deciphered' },
  { id: 'khitan_small', display: 'Khitan Small Script', family_id: 'east_asian', region: 'Mongolia/Manchuria', writing_type: 'syllabary', status: 'partially_deciphered' },
  { id: 'jurchen', display: 'Jurchen Script', family_id: 'east_asian', region: 'Manchuria', writing_type: 'logographic', status: 'partially_deciphered' },
  { id: 'naxi_dongba', display: 'Naxi Dongba', family_id: 'east_asian', region: 'Yunnan', writing_type: 'logographic', status: 'partially_deciphered' },
  ...
  { id: 'lycian', display: 'Lycian', family_id: 'anatolian', region: 'Southwest Anatolia', writing_type: 'alphabet', status: 'deciphered' },
  { id: 'lydian', display: 'Lydian', family_id: 'anatolian', region: 'Western Anatolia', writing_type: 'alphabet', status: 'deciphered' },
  { id: 'carian', display: 'Carian', family_id: 'anatolian', region: 'Southwest Anatolia', writing_type: 'alphabet', status: 'deciphered' },
  { id: 'phrygian', display: 'Phrygian', family_id: 'anatolian', region: 'Central Anatolia', writing_type: 'alphabet', status: 'deciphered' },
  ...
  { id: 'tifinagh', display: 'Tifinagh (Berber)', family_id: 'northeast_african', region: 'North Africa', writing_type: 'abjad', status: 'deciphered' },
  { id: 'numidian', display: 'Numidian', family_id: 'northeast_african', region: 'North Africa', writing_type: 'alphabet', status: 'partially_deciphered' },
  { id: 'vai', display: 'Vai', family_id: 'northeast_african', region: 'West Africa', writing_type: 'syllabary', status: 'deciphered' },
  { id: 'nko', display: "N'Ko", family_id: 'northeast_african', region: 'West Africa', writing_type: 'alphabet', status: 'deciphered' },
  { id: 'bamum', display: 'Bamum', family_id: 'northeast_african', region: 'Cameroon', writing_type: 'syllabary', status: 'deciphered' },
  ...
  { id: 'oscan', display: 'Oscan', family_id: 'european', region: 'Italy', writing_type: 'alphabet', status: 'deciphered' },
  { id: 'umbrian', display: 'Umbrian', family_id: 'european', region: 'Italy', writing_type: 'alphabet', status: 'deciphered' },
  { id: 'ogham', display: 'Ogham', family_id: 'european', region: 'Ireland/Britain', writing_type: 'alphabet', status: 'deciphered' },
  { id: 'iberian', display: 'Iberian', family_id: 'european', region: 'Iberian Peninsula', writing_type: 'semi_syllabary', status: 'partially_deciphered' },
  { id: 'celtiberian', display: 'Celtiberian', family_id: 'european', region: 'Iberian Peninsula', writing_type: 'semi_syllabary', status: 'deciphered' },
  { id: 'old_church_slavonic', display: 'Old Church Slavonic', family_id: 'european', region: 'Balkans', writing_type: 'alphabet', status: 'deciphered' },
  { id: 'elder_futhark', display: 'Elder Futhark', family_id: 'european', region: 'Northern Europe', writing_type: 'alphabet', status: 'deciphered' },
  { id: 'younger_futhark', display: 'Younger Futhark', family_id: 'european', region: 'Scandinavia', writing_type: 'alphabet', status: 'deciphered' },
  ...
  { id: 'zapotec', display: 'Zapotec', family_id: 'mesoamerican', region: 'Oaxaca', writing_type: 'logosyllabic', status: 'partially_deciphered' },
  { id: 'isthmian', display: 'Isthmian (Epi-Olmec)', family_id: 'mesoamerican', region: 'Gulf Coast', writing_type: 'logosyllabic', status: 'partially_deciphered' },
  { id: 'aztec', display: 'Aztec (Nahuatl)', family_id: 'mesoamerican', region: 'Central Mexico', writing_type: 'logographic', status: 'deciphered' },
  ...
  { id: 'balinese', display: 'Balinese', family_id: 'southeast_asian', region: 'Bali', writing_type: 'abugida', status: 'deciphered' },
  { id: 'baybayin', display: 'Baybayin', family_id: 'southeast_asian', region: 'Philippines', writing_type: 'abugida', status: 'deciphered' },
  { id: 'lontara', display: 'Lontara (Bugis)', family_id: 'southeast_asian', region: 'Sulawesi', writing_type: 'abugida', status: 'deciphered' },
  { id: 'batak', display: 'Batak', family_id: 'southeast_asian', region: 'Sumatra', writing_type: 'abugida', status: 'deciphered' },
  { id: 'lao', display: 'Lao', family_id: 'southeast_asian', region: 'Laos', writing_type: 'abugida', status: 'deciphered' },
  { id: 'cham', display: 'Cham', family_id: 'southeast_asian', region: 'Vietnam/Cambodia', writing_type: 'abugida', status: 'deciphered' },
  ...
  { id: 'rongorongo', display: 'Rongorongo', family_id: 'undeciphered', region: 'Easter Island', writing_type: 'unknown', status: 'undeciphered' },
  { id: 'wadi_el_hol', display: 'Wadi el-Hol', family_id: 'undeciphered', region: 'Egypt', writing_type: 'proto_alphabet', status: 'partially_deciphered' },
  { id: 'dispilio', display: 'Dispilio Tablet', family_id: 'undeciphered', region: 'Greece', writing_type: 'unknown', status: 'undeciphered' },
  { id: 'jiahu', display: 'Jiahu Symbols', family_id: 'undeciphered', region: 'China', writing_type: 'proto_writing', status: 'undeciphered' },
  { id: 'sitovo', display: 'Sitovo Inscription', family_id: 'undeciphered', region: 'Bulgaria', writing_type: 'unknown', status: 'undeciphered' },
  { id: 'cascajal', display: 'Cascajal Block', family_id: 'undeciphered', region: 'Mesoamerica', writing_type: 'logographic', status: 'undeciphered' },
  { id: 'samaritan', display: 'Samaritan', family_id: 'semitic', region: 'Levant', writing_type: 'abjad', status: 'deciphered' },
  { id: 'mandaic', display: 'Mandaic', family_id: 'semitic', region: 'Mesopotamia', writing_type: 'alphabet', status: 'deciphered' },
  { id: 'palmyrene', display: 'Palmyrene', family_id: 'semitic', region: 'Syria', writing_type: 'abjad', status: 'deciphered' },
  { id: 'hatran', display: 'Hatran', family_id: 'semitic', region: 'Mesopotamia', writing_type: 'abjad', status: 'deciphered' },
  { id: 'cherokee', display: 'Cherokee Syllabary', family_id: 'isolates', region: 'North America', writing_type: 'syllabary', status: 'deciphered' },
